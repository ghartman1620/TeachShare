# Generated by Django 2.0.3 on 2018-04-24 19:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('posts', '0009_auto_20180421_0941'),
    ]

    operations = [
        migrations.AddField(
            model_name='post',
            name='crosscutting_concepts',
        ...
        migrations.AlterField(
            model_name='post',
            name='grade',
            field=models.IntegerField(choices=[(0, 'Preschool'), (1, 'Kindergarten'), (2, 'First Grade'), (3, 'Second Grade'), (4, 'Third Grade'), (5, 'Fourth Grade'), (6, 'Fifth Grade'), (7, 'Sixth Grade'), (8, 'Seventh Grade'), (9, 'Eighth Grade'), (10, 'High School')], default=0),
        ),
        migrations.AlterField(
            model_name='standard',
            name='grade',
            field=models.IntegerField(choices=[(0, 'Preschool'), (1, 'Kindergarten'), (2, 'First Grade'), (3, 'Second Grade'), (4, 'Third Grade'), (5, 'Fourth Grade'), (6, 'Fifth Grade'), (7, 'Sixth Grade'), (8, 'Seventh Grade'), (9, 'Eighth Grade'), (10, 'High School')]),
        ),
    ]
