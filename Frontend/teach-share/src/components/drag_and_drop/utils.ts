...
export type LayoutItem = LayoutItemRequired &
                         {minW?: number, minH?: number, maxW?: number, maxH?: number,
                          ...
                          isDraggable?: boolean | null, isResizable?: boolean | null};
 ...
 */
export function moveElement(layout: Layout, l: LayoutItem, x: Number | undefined, y: Number | undefined, isUserAction: boolean): Layout {
...
export function moveElementAwayFromCollision(layout: Layout, collidesWith: LayoutItem,
                                             itemToMove: LayoutItem, isUserAction: boolean | null): Layout {
 ...
 * @returns {string}
 */
export function createMarkup(obj): string {
 ...
 * @returns {*}
 */
export function addPx(name, value): any {
