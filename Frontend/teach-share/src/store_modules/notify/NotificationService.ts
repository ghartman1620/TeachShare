...
const { commit, read, dispatch } =
     getStoreAccessors<NotifyState, RootState>("");


/**
 * Actions Handlers
 */
export const sendNotification = dispatch(NotificationService.actions.sendNotification);
export const removeNotification = dispatch(NotificationService.actions.removeNotification);
/**
 * Getters Handlers
 */
export const getAllNotifications = read(NotificationService.getters.getAllNotifications);
